...
HELP_TEXT = (
    "Sou o Alfred, o teu funcionário local (qwen3:8b).\n"
    "Windows: 'abre photoshop', 'abre chrome', 'lista programas'.\n"
    "Ficheiros: leio pastas do teu perfil; NÃO apago/edito sem AUTORIZO. "
    "Sempre mostro os paths. Não toco em Windows/Program Files/segredos.\n"
    "Criativos: 'cria um criativo sobre X' → plano + pausa agentes extra + Photoshop.\n"
    "Skills: 'procura skill sobre photoshop'.\n"
    "Modo funcionário: 'modo funcionario' pausa bridge/engine/matriz/voz (Ollama/Hermes/Alfred ficam). "
    "'volta ao aura' sai do foco.\n"
    "GPU extra: 'exporta worker gpu' gera ZIP para outro PC (até 60% VRAM, pausa com jogos). "
    "'liga worker 192.168.x.x'. A VRAM do outro PC NÃO entra na tua: ele corre o trabalho e devolve o resultado.\n"
    "Mutável = AUTORIZO. paper_trade/execution_allowed não mudam."
)
