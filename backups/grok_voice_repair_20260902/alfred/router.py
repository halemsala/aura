...
OPEN_APP_RE = re.compile(r"^abre(?:\s+o|\s+a)?\s+(photoshop|illustrator|chrome|edge|notepad|paint|explorer|code|word|excel|vscode)$", re.I)
...
SYSTEM_CONTROL_RE = re.compile(
    ...
    r"exporta(?:r)? worker gpu|workers gpu|abre(?:\s+o)?\s+photoshop)\b",
    re.I)
